...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_programs_institution_id"), "programs", ["institution_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_candidate_profiles_cpf"), "candidate_profiles", ["cpf"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("COURSE", "SCHOLARSHIP", "INTERNSHIP", name="offertype"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("DRAFT", "PUBLISHED", "EXPIRED", "DELETED", name="offerstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_offers_institution_id"), "offers", ["institution_id"], unique=False
    )
    op.create_index(
        op.f("ix_offers_program_id"), "offers", ["program_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_applications_offer_id"), "applications", ["offer_id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_applications_candidate_profile_id"), table_name="applications"
    )
